...
class SingleWarehouseInventoryItem extends Component {
    state = {
        display: false,
    }
    ...
    removeDeleteModuleInventory = () => {
        ...
        axios.delete(`http://localhost:8080/${this.props.inventory.warehouseID}/inventory/${this.props.inventory.id}`).then(
...
export default SingleWarehouseInventoryItem;